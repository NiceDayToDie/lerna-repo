...
// CONCATENATED MODULE: ./src/time-util.ts




var TimeUtil = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  function TimeUtil() {
  ...
  _createClass(TimeUtil, null, [{
    ...
    value: function getDelta(start, end) {
      ...
      var use = now.diff(moment(start));
      return moment.duration(use).asMilliseconds();
    }
  }, {
    key: "getDeltaTime",
    value: function getDeltaTime(start, end) {
...
/******/ 	return __webpack_require__(8559);
/******/ })()
.default;
});